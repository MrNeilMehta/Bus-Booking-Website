			...
			<div className='bg-#fff0dd w-full h-[100%] flex font-main overflow-visible'>
				<div className='bg-#fff0dd w-full h-full rounded-l-3xl flex justify-center items-center'>
					<div className='flex flex-col'>
						<div className='text-center text-4xl font-bold'>Create Route</div>
						<div className='container rounded-2xl bg-white min-w-full min-h-full p-8 shadow-md mb-8'>
							<form>
								...
								<div className='flex flex-col min-w-full min-h-full mb-6'>
									<label className='mb-1 font-bold text-black text-left'>
										Email ID:
									</label>
									<div className='flex flex-row flex-wrap'>{email}</div>
								</div>
							</form>
						</div>
								...
								<div>
									{flag ? (
										...
										stops.map((stops, i) => (
											<div
												key={i}
												className='flex flex-col min-w-full min-h-full mb-6 text-left'
											>
												Stop {stops.id + 1} <br />
								...
								<div className='flex flex-col min-w-full min-h-full mb-6'>
									...
									<div className='flex flex-row flex-wrap'>
										<input
											...
											type='text'
											name='name'
											className='rounded-xl border border-redbus bg-offwhite w-96 p-1 mb-4'
											onChange={handleNameChange}
										/>
									</div>
									<label className='mb-1 font-semibold text-black'>
										Time to Reach from Source (in minutes):{' '}
									</label>
									<div className='flex flex-row flex-wrap'>
										<input
											value={stopTime}
